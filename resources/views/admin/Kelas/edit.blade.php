...
<div class="admin-guru-container">
    ...
    <div class="page-header-admin-guru">
        <div class="header-content-admin-guru">
            ...
            <div>
                <h1 class="page-title-admin-guru">Edit Kelas</h1>
                <p class="page-subtitle-admin-guru">Ubah data kelas yang sudah ada</p>
            </div>
        </div>
    </div>
{{-- ALERT ERROR --}}
                        ...
                        >
                            ...
                            @foreach($guru as $g)
                                <option value="{{ $g->id_guru }}"
                                    {{ old('id_guru', $kelas->id_guru) == $g->id_guru ? 'selected' : '' }}>
                                    {{ $g->nama }}
                                </option>
                            @endforeach
                        </select>
